...
pathsgs <- read.csv("pathsgs_isotropic.csv",header=F)

annrnlist <- read.neurons(as.character(paste0(pathsgs$V1,".radius.swc_sorted.swc")),neuronnames=gsub("_resampled.swc","",pathsgs$V1))
save(annrnlist, file='annrnlist_isotropic.Rdata')
