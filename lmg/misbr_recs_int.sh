...
do
    I1="gold_163_all_soma_sort_s1_int/$D/"*swc
    for I2 in "gold_163_all_soma_sort_s1_int/$D/auto_recons/"*swc
    do
    ...
    for I2 in "gold_163_all_soma_sort_s1_int/$D/processed/"*swc
    do
        vaa3d -x missing_branch_detection -f missing_branch_detection -i ../BigNeurongit/Data/gold166_wids_vols/$D/$D.v3dpbd $I2 -o $I2.missing_branches
    done
