...
for(i in unique(ml$ids)){
  bestalg <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == min(ml[ml$ids==i,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm
  ml[ml$ids == i,]$bestalg <- bestalg[1]
  bestalg2 <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == min(ml[ml$ids==i & ml$algorithm!=bestalg,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm
  ml[ml$ids == i,]$bestalg2 <- bestalg2[1]
  bestalg3 <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == min(ml[ml$ids==i & ml$algorithm!=bestalg & ml$algorithm!=bestalg2,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm
  ml[ml$ids == i,]$bestalg3 <- bestalg3[1]
  bestalg4 <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == min(ml[ml$ids==i & ml$algorithm!=bestalg & ml$algorithm!=bestalg2 & ml$algorithm!=bestalg3,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm
  ml[ml$ids == i,]$bestalg4 <- bestalg4[1]
  bestalg5 <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == min(ml[ml$ids==i & ml$algorithm!=bestalg & ml$algorithm!=bestalg2 & ml$algorithm!=bestalg3 & ml$algorithm!=bestalg4,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm
  ml[ml$ids == i,]$bestalg5 <- bestalg5[1]
  bestalg6 <- ml[ml$`entire.structure.average..from.neuron.1.to.2.` == min(ml[ml$ids==i & ml$algorithm!=bestalg & ml$algorithm!=bestalg2 & ml$algorithm!=bestalg3 & ml$algorithm!=bestalg4 & ml$algorithm!=bestalg5,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm
  ml[ml$ids == i,]$bestalg6 <- bestalg6[1]
  bestalg7 <- ml[ml$`entire.structure.average..from.neuron.1.to.2.` == min(ml[ml$ids==i & ml$algorithm!=bestalg & ml$algorithm!=bestalg2 & ml$algorithm!=bestalg3 & ml$algorithm!=bestalg4 & ml$algorithm!=bestalg5 & ml$algorithm!=bestalg6,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm
  ml[ml$ids == i,]$bestalg7 <- bestalg7[1]
  bestalg8 <- ml[ml$`entire.structure.average..from.neuron.1.to.2.` == min(ml[ml$ids==i & ml$algorithm!=bestalg & ml$algorithm!=bestalg2 & ml$algorithm!=bestalg3 & ml$algorithm!=bestalg4 & ml$algorithm!=bestalg5 & ml$algorithm!=bestalg6 & ml$algorithm!=bestalg7,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm
  ml[ml$ids == i,]$bestalg8 <- bestalg8[1]
  
  worstalg <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == max(ml[ml$ids==i,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm[1]
  ml[ml$ids == i,]$worstalg <- worstalg[1]
  worstalg2 <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == max(ml[ml$ids==i & ml$algorithm!=worstalg,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm[1]
  ml[ml$ids == i,]$worstalg2 <- worstalg2[1]
  worstalg3 <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == max(ml[ml$ids==i & ml$algorithm!=worstalg & ml$algorithm!=worstalg2,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm[1]
  ml[ml$ids == i,]$worstalg3 <- worstalg3[1]
  worstalg4 <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == max(ml[ml$ids==i & ml$algorithm!=worstalg & ml$algorithm!=worstalg2 & ml$algorithm!=worstalg3,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm[1]
  ml[ml$ids == i,]$worstalg4 <- worstalg4[1]
  worstalg5 <- ml[ml$ids==i & ml$`entire.structure.average..from.neuron.1.to.2.` == max(ml[ml$ids==i & ml$algorithm!=worstalg & ml$algorithm!=worstalg2 & ml$algorithm!=worstalg3 & ml$algorithm!=worstalg4,]$`entire.structure.average..from.neuron.1.to.2.`),]$algorithm[1]
...
p <- ggplot(ml[ml$algorithm == ml$bestalg,], aes(x=entire.structure.average..from.neuron.1.to.2., fill=algorithm)) + geom_density(alpha=0.4)
# ggplotly(p)
p <- ggplot(ml, aes(x=entire.structure.average..from.neuron.1.to.2., fill=ids)) + geom_density(alpha=0.4)
# ggplotly(p)
plot(density(ml$entire.structure.average..from.neuron.1.to.2.),main="Percentage of difference to GS for all algorithms")
pddf <- data.frame(pcdiff=ml$entire.structure.average..from.neuron.1.to.2., set = "All algorithms",ids=ml$ids)
plot(density(ml$entire.structure.average..from.neuron.1.to.2.[ml$algorithm == ml$bestalg]),main="Percentage of difference to GS for true best algorithms")
pddf2 <- data.frame(pcdiff=ml$entire.structure.average..from.neuron.1.to.2.[ml$algorithm == ml$bestalg], set = "True best algorithms")
...
# remove near ZeroVar
disml <- ml[,c(1:20,22:50)]  #ml[,1:56]
disml <- disml[,-nearZeroVar(disml,freqCut=2,uniqueCut=20)]
...
entire.structure.average..from.neuron.1.to.2. <- ml[,21]
ml <- cbind(disml,entire.structure.average..from.neuron.1.to.2.,algorithm,bestalg)
ml$ids <- ids2

ml$entire.structure.average..from.neuron.1.to.2. <- as.factor(ml$entire.structure.average..from.neuron.1.to.2.)
...
ml$entire.structure.average..from.neuron.1.to.2. <- as.numeric(as.character(ml$entire.structure.average..from.neuron.1.to.2.))
...
ml$algorithm <- NULL
ml$ids <- NULL
task = TaskRegr$new(id = "alg", backend = ml, target = "entire.structure.average..from.neuron.1.to.2.")#, extra_args = list(group="ids"))
...
for (i in unique(idsml[which(!(idsml %in% idstrain))])){
  preddf[preddf$ids == i,]$pctdiffstr_truth <- ml$entire.structure.average..from.neuron.1.to.2.[prediction$data$row_ids[prediction$data$row_ids %in% which(idsml==i)][which.min(prediction$data$truth[prediction$data$row_ids %in% which(idsml==i)])]]
  preddf[preddf$ids == i,]$pctdiffstr_pred <- ml$entire.structure.average..from.neuron.1.to.2.[prediction$data$row_ids[prediction$data$row_ids %in% which(idsml==i)][which.min(prediction$data$response[prediction$data$row_ids %in% which(idsml==i)])]]
  preddf[preddf$ids == i,]$pctdiffstr_pred_worse <- ml$entire.structure.average..from.neuron.1.to.2.[prediction$data$row_ids[prediction$data$row_ids %in% which(idsml==i)][which.max(prediction$data$response[prediction$data$row_ids %in% which(idsml==i)])]]
