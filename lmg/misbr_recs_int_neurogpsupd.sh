...
do
    I1="gold_163_all_soma_sort_s1_int/$D/"*NeuroGPSTree_updated.swc
    for I2 in "gold_163_all_soma_sort_s1_int/$D/auto_recons/"*NeuroGPSTree_updated.swc
    do
    ...
    for I2 in "gold_163_all_soma_sort_s1_int/$D/processed/"*NeuroGPSTree_updated.swc
    do
        vaa3d -x missing_branch_detection -f missing_branch_detection -i ../BigNeurongit/Data/gold166_wids_vols/$D/$D.v3dpbd $I2 -o $I2.missing_branches
    done
